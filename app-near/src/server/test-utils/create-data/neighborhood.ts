...
export const createNeighborhood = async (surveyName: string) => {
  ...
  await db.$queryRawUnsafe(`CREATE OR REPLACE VIEW quartiers AS
      SELECT 
        ...
        110::double precision AS c21_h15p_cs1_sum,
        110::double precision AS c21_f15p_cs1_sum,
        55::double precision AS c21_h15p_cs2_sum,
        55::double precision AS c21_f15p_cs2_sum,
        90::double precision AS c21_h15p_cs3_sum,
        90::double precision AS c21_f15p_cs3_sum,
        75::double precision AS c21_h15p_cs4_sum,
        75::double precision AS c21_f15p_cs4_sum,
        25::double precision AS c21_h15p_cs5_sum,
        25::double precision AS c21_f15p_cs5_sum,
        60::double precision AS c21_h15p_cs6_sum,
        60::double precision AS c21_f15p_cs6_sum,
        40::double precision AS c21_h15p_cs7_sum,
        40::double precision AS c21_f15p_cs7_sum,
        45::double precision AS c21_h15p_cs8_sum,
        45::double precision AS c21_f15p_cs8_sum,
