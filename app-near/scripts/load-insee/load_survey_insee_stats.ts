...
const createQuartiersView = async (survey_id: number) => {
 ...
 intermediates as (SELECT ${survey_id} AS survey_id,
   ARRAY['751145501', '751145503', '751145601' ] AS iris_selectors,
    ...
    sum(c21_h15p_cs1) AS c21_h15p_cs1_sum,
    sum(c21_f15p_cs1) AS c21_f15p_cs1_sum,
    sum(c21_h15p_cs2) AS c21_h15p_cs2_sum,
    sum(c21_f15p_cs2) AS c21_f15p_cs2_sum,
    sum(c21_h15p_cs3) AS c21_h15p_cs3_sum,
    sum(c21_f15p_cs3) AS c21_f15p_cs3_sum,
    sum(c21_h15p_cs4) AS c21_h15p_cs4_sum,
    sum(c21_f15p_cs4) AS c21_f15p_cs4_sum,
    sum(c21_h15p_cs5) AS c21_h15p_cs5_sum,
    sum(c21_f15p_cs5) AS c21_f15p_cs5_sum,
    sum(c21_h15p_cs6) AS c21_h15p_cs6_sum,
    sum(c21_f15p_cs6) AS c21_f15p_cs6_sum,
    sum(c21_h15p_cs7) AS c21_h15p_cs7_sum,
    sum(c21_f15p_cs7) AS c21_f15p_cs7_sum,
    sum(c21_h15p_cs8) AS c21_h15p_cs8_sum,
    sum(c21_f15p_cs8) AS c21_f15p_cs8_sum,
